...
import { BookOpenText, GraduationCap, LayoutDashboard, School, UserRoundSearch } from "lucide-react";

export type AdminSection = "dashboard" | "classes" | "tutors" | "requests" | "posts";
  ...
  return (
    <aside className="border-b border-slate-200 bg-white lg:min-h-[calc(100vh-76px)] lg:border-b-0 lg:border-r">
      <div className="p-4 lg:p-5">
        <p className="mb-4 hidden text-xs font-black uppercase tracking-[.16em] text-slate-400 lg:block">Quản trị mock</p>
