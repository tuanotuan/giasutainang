...
export const metadata: Metadata = { title: "Điều khoản sử dụng", description: "Điều khoản sử dụng website Gia Sư Tài Năng." };
export default function TermsPage() {
  return <LegalPage title="Điều khoản sử dụng" description="Các nguyên tắc cơ bản khi truy cập và sử dụng nền tảng kết nối gia sư." sections={[
    { title: "Phạm vi dịch vụ", content: "Tài Năng đóng vai trò kết nối nhu cầu học tập và hồ sơ gia sư phù hợp. Website không bảo đảm kết quả điểm số cụ thể và không thay thế trách nhiệm trao đổi trực tiếp giữa gia đình với người dạy." },
