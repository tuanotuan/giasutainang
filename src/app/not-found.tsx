  ...
  return (
    <section className="flex min-h-[60vh] items-center bg-slate-50 py-16 text-center">
      <div className="container-page">
        ...
        <span className="mt-5 block text-sm font-extrabold tracking-[.2em] text-primary-600">404</span>
        <h1 className="mt-3 text-3xl font-extrabold text-ink sm:text-4xl">Trang bạn tìm không tồn tại</h1>
