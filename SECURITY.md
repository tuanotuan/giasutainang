...
Last updated: 2026-07-15. Public chat hybrid FAQ/AI path reviewed: deterministic public D1 facts, two-model cascade, bounded sanitized history/output, prompt-injection guardrails, rate limiting, safe coarse health diagnostics, and no raw AI errors exposed.
