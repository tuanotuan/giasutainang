...
const htmlPath = path.join(outputDir, "50-ho-so-gia-su-tai-nang.html");
const pdfPath = path.join(outputDir, "50-ho-so-gia-su-tai-nang.pdf");
...
if (tutors.length !== 50) throw new Error(`Cần đúng 50 hồ sơ, hiện nhận được ${tutors.length}.`);
...
const html = `<!doctype html><html lang="vi"><head><meta charset="utf-8"><title>50 hồ sơ gia sư - Gia Sư Tài Năng</title><style>
