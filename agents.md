...
- Keep bucket `giasutainang-files` bound as `FILES`; application upload remains the active acceptance feature until it is deployed and owner-tested.
...
Last updated: 2026-07-12 — private R2 bucket is configured as `FILES`; waiting for deployment and owner acceptance before the next upgrade.
